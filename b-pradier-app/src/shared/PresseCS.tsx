...
export default function PresseCS() {
    const millesimes = [
        ...
        // },
        {
            ...
            description1:
                "The WINE ADVOCATE 2001 de Robert Parker: « J’ai goûté les vins de ce producteur, en faible quantité sur le marché, que j’ai tous trouvé plaisant, mais celui là est sortit du lot. La cuvée Sylviane 2000, aux notes de cerises noires et cassis est ample en bouche bien que pas très complexe, avec un gras admirable et une grande pureté. »",
            description2: "",
