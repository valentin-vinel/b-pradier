    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center w-full max-w-[300px] m-auto lg:hidden text-center">
                <select value={selectedIndex} onChange={(e) => setSelectedIndex(Number(e.target.value))} className="mb-6 border border-[#a59582] rounded-md p-2 text-center bg-[#fcf7f1]">
                    {cuvees.map((cuvee, i) => (
                ...
                <div className="flex flex-col gap-6 items-center">
                    <figure className="flex flex-col justify-center items-center relative">
                        ...
                        <h3 className={`text-2xl text-white absolute h-fit m-auto translate-y-4 w-[180px] font-bold uppercase ${collectionFonts[selectedCuvee.title]}`}>{selectedCuvee.title}</h3>
                    </figure>
