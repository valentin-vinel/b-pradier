...
export default function AddToCartButton({ variantId, quantity = 1, className = "" }: AddToCartButtonProps) {
    ...
    return (
        <button onClick={handleClick} disabled={loading} className={`bg-[#D4BFA6] border-2  text-base hover:cursor-pointer hover:text-[#6b1e1e] relative w-[210px] ${className}`}>
