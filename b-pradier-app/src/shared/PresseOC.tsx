    ...
    const millesimes = [
        {
            ...
            description1:
                "Guide Bettane & Desseauve 2015 «... Les différentes cuvées produites ont toutes une expression très droite et au toucher fin. Puissant, épicé, bouche généreuse… » 14/20. Spécial vin Le Point, 15/20: « Fruits noirs compotés, bigarreau très mûrs, poivre, ample, dense charnu; fleurs sèches,, long, savoureux ».",
        ...
        },
        {
            ...
            description1:
                "Cuisine et Vins de France, dans son « Spécial hors série Foire aux vins », d’octobre 2011, conseille ce premier Millésime de L’Orée des Collines parmi les 150 bouteilles à acheter en disant: « Mûre à souhait, tout en volume, patinée de fruits noirs, au nez elle ajoute notes de poire affinée un an en fûts, encore légèrement boisée en finale, elle exige un à deux ans en cave pour parfaire son élevage ».",
            description2: "",
