...
export default function PresseGR() {
    const millesimes = [
        ...
        },
        {
            ...
            description1:
                "Dans « The WINE ADVOCATE 2001 » de Robert Parker: « J'ai goûté les vins de ce producteur, en faible quantité sur le marché, que j'ai tous trouvé plaisant, mais celui-là est sorti du lot. Ce vin est sur un beau fruit à baie noire avec une bonne acidité, une sensation de fruit riche et concentré, moyennement tannique et d'une excellente pureté. En raison d'une plus grande maturité, le 1999 est plus sec que le 2000 ».",
            description2:
        ...
        },
        {
            ...
            description1:
                "Le Guide Fleurus des vins 2004: « Robe rubis aux reflets violets, nez ample sur des arômes kirchés, confiturés et torréfiés. Attaque généreuse aux notes épicées de poivre, réglisse. Bouche dotée de tanins fins. Finale dans un registre animal (cuit). Un vin bien charpenté qui demeure agréable et élégant ».",
            description2:
        ...
        // },
        {
            ...
            description1:
                "Guide Hachette des vins 1997* « Un soin très particulier a été apporté à la vendange issue de vieilles vignes: trié une première fois sur la parcelle, le raisin est transporté en caisses puis trié à nouveau à la cave. Ce produit d'une telle méticulosité ne peut que se distinguer par sa puissance ».",
            description2: "",
        ...
        // },
        {
            ...
            description1:
                "Distinguée par Le Guide Hachette des Vins 1995*: «... les Pradier passent encore haut la main l'examen Hachette. La robe d'un rouge profond et soutenue laisse présager un vin de bonne constitution. Les arômes sont présents. La bonne charpente permet une bouche longue. Un 92 qui se maintient tout au long de la dégustation ».",
        ...
        // },
        {
            ...
            description1:
                "Dans le Figaro Magazine, 2 Novembre 1991 l'élite des sommeliers la proposaient dans « Leurs caves idéales » c'est-à-dire Jean-Claude Jambon, meilleur sommelier du monde en 1986, Jean-Luc Pouteau, meilleur sommelier du monde en 1983 et Didier Bordas, sommelier conseil aux caves Taillevent à Paris.",
            description2:
        ...
        },
        {
            ...
            description2:
                "En 1991 aussi, dans Le Figaro Magazine, l'élite des sommeliers, Jean Claude Jambon, meilleur sommelier du monde en 1986, Jean-Luc Pouteau, meilleur sommelier du monde en 1983 et Didier Bordas, sommelier conseil aux caves Taillevent à Paris, ont conjugué leurs talents pour proposer « Leurs caves idéales ».",
            ...
            {millesimes.reverse().map((millesime) => (
                <article className="border p-2 mb-2" key={millesime.title}>
                    <h3 className="text-secondary text-center mb-2">
                        <Link href={`millesimes/${millesime.slug}`} className="font-bold ">
                            {millesime.title}
                        </Link>
                    </h3>
                    <p className="mb-1 text-justify px-1 hyphens-auto">{millesime.description1}</p>
                    <p className="text-justify px-1 hyphens-auto">{millesime.description2}</p>
                </article>
            ))}
        </div>
    );
