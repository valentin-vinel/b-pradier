    ...
    return (
        <div className="min-h-screen flex flex-col max-w-[1200px] m-auto px-3 lg:px-0">
            ...
            <main className="flex flex-col gap-4 mt-4 text-center lg:text-justify">
                <h2 className="text-center text-red text-3xl">LES DÉGUSTATIONS « EN LIGNES... GÉOMÉTRIQUES »</h2>
                ...
                <p className="max-w-[840px] m-auto mb-4">
                    Rassurez-vous on n'a pas, bien heureusement, inventé la dégustation du vin par Internet... Je vous propose des méthodes pour « qu'en vrai et en direct », si je peux ainsi m'exprimer, vous compreniez nos différentes cuvées aux quatre points communs. Qui sont, issus d'un seul domaine, d'un terroir identique, vinifié par le même vigneron et des vins qui ne soient pas de l'année. Comme le disait mon père lorsqu'il ouvrait un vin, dans le temps les jours de fêtes, quand j'avais 20 ans : « Il doit avoir au moins 7 années de vie en bouteille... car c'est l'âge de raison ! » Elles n'ont pas pour but de se substituer à un cours d'œnologie, ni aux commentaires de sommeliers, mais complémentaires, pour saisir l'esprit des vins et peut-être aussi entre percevoir... l'âme du vin !
                </p>
                ...
                <div className="flex flex-col gap-12 my-10">
                    <section className="max-w-[800px] m-auto border p-4">
                        ...
                        <p>
                            Avec mes trois cuvées, cette « forme » de dégustation d'un même millésime, mais de cépages, de vinifications et d'élevages différents, vous cernerez ainsi les profils qui en résultent et l'incidence sur leurs typicités qu'on leurs « modes » d'élaboration... et les plus « justes formules » d'accords avec les mets.
                        </p>
                    </section>
                    ...
                    <section className="max-w-[800px] m-auto border p-4">
                        ...
                        <p>
                            Deuxième figure de dégustation d'une cuvée, sur au moins trois millésimes successifs, pour vous permettre de suivre son évolution au fil des années et ainsi remonter le temps, « pour revivre la genèse d'un vin... comme si l'on feuillettait un album photos de famille ! »
                        </p>
                    </section>
