            ...
            <main className="flex flex-col gap-4 mt-4 text-center lg:text-justify">
                ...
                <div className="flex flex-col gap-12 my-10">
                    <section className="max-w-[800px] m-auto border p-4">
                        ...
                        <p>
                            Avec mes trois cuvées, cette « <em>forme</em> » de dégustation d'un même millésime, mais de cépages, de vinifications et d'élevages différents, vous cernerez ainsi les profils qui en résultent et l'incidence sur leurs typicités qu'on leurs « <em>modes</em> » d'élaboration... et les plus « <em>justes formules</em> » d'accords avec les mets.
                        </p>
                    </section>
                    ...
                    <section className="max-w-[800px] m-auto border p-4">
                        ...
                        <p>
                            Deuxième figure de dégustation d'une cuvée, sur au moins trois millésimes successifs, pour vous permettre de suivre son évolution au fil des années et ainsi remonter le temps, « <em>pour revivre la genèse d'un vin... comme si l'on feuillettait un album photos de famille !</em> »
                        </p>
                    </section>
