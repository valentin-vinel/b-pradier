...
export default function Home() {
    return (
        <div className="min-h-screen flex flex-col max-w-[1200px] m-auto px-4 lg:px-0">
            ...
            <main className="md:text-justify whitespace-pre-line m-auto md:mt-2 md:mb-12">
                ...
                <p  className="">
                    Grâce à cela je peux vous proposer encore des Château d’Hugues, mais uniquement par ce site ! La raison en est qu’il y aura en mai deux ans, j’ai fait un A V C... J’en ai réchappé, si ce n’est avec quelques séquelles, qui m’empêchent de vous recevoir. <br />Aussi je vous invite à profiter, pour vos repas de fêtes de Nöel, du nouvel an... et pour offrir, ou mettre dans votre cave, en 2025, en particulier : <strong className="font-normal underline">des vins des trois cuvées de notre Millésime 2005, mises à l’honneur car c’est leur 20ème anniversaire !</strong>
                </p>
                <p  className="">
