...
export default function Home() {
    return (
        <div className="min-h-screen flex flex-col max-w-[1200px] m-auto px-4 lg:px-0">
            ...
            <h2 className="text-red text-center lg:mt-8  text-3xl">- MILLÉSIMES 1988 JUSQU'À 2010 -</h2>
            ...
            <main className="text-center md:text-justify whitespace-pre-line m-auto md:mt-2 md:mb-12 max-w-[970px]">
                ...
                <Image src={bouchon} alt="Dessin d'un bouchon de liège du chateau d'Hugues" className="m-auto max-w-[150px]"></Image>
            </main>
