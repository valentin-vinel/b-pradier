    ...
    return (
        <div className="min-h-screen flex flex-col max-w-[1200px] m-auto px-3 lg:px-0">
            ...
            <main className="flex flex-col gap-4 mt-6 text-center lg:text-justify">
                <h2 className="text-2xl text-center text-red">NOS TROIS CUVEES DE GRANDE GARDE... « DIFFERENTES » ET « COMPLEMENTAIRES »</h2>
                ...
                <div className="flex flex-col gap-16 my-10 ">
                    <article className="flex flex-col gap-12 justify-between mb-10">
                    ...
                    <article className="flex flex-col gap-12 justify-between mb-10">
                        ...
                        <div className="flex flex-col justify-center items-center gap-2">
                            <p className="max-w-[840px]">
                                En 1998, nous avons vinifié une cuvée en hommage à mon épouse Sylviane. Alliance de Grenache, Syrah et Mourvèdre, vendangés plus tardivement et vinifiés « sans éraflage », ni passage en fûts de chêne, pour lui conserver toute son authenticité. Un vin puissant, structuré et riche aux arômes de réglisse, d’une touche poivrée... Sur les plats régionaux comme un pôt-au-feu, daubes et gibiers à poil sauce au vin rouge.
                            </p>
                        </div>
                    </article>
