    ...
    return (
        <div className="min-h-screen flex flex-col max-w-[1200px] m-auto px-4 lg:px-0">
            ...
            <main className="text-center md:text-start lg:text-justify whitespace-pre-line m-auto md:mt-2 md:mb-12 max-w-[730px]">
                <p className="my-4">Chers clients, chères Madames, chers Monsieurs,</p>
                ...
                <p >
                    <strong>« Millésimes 2010 à 2000, début du XXIème siècle »</strong> : Avec des amis, plusieurs fois par an, nous sélectionnons une année pour une dégustation de nos trois cuvées.
                    Cela pour dire, l'excellent état de conservation de mes vins et de leurs bouchons... qui ont entre 16 et 26 ans !
                    {/* Dont certains ont déjà fêté leurs 20ème anniversaire ! */}
                </p>
                <p className="lg:[text-align-last:justify]">
                    Cette année, comme il se doit, c'est le Millésime 2006 qui est à l'honneur. 
                </p>
                <p className="mb-4">
                    Une belle année prête à déguster, à la différence, entres autres, avec les Millésimes 2009, 2005 et 2001, à peine ouvert.
                </p>
                <p className="mb-2">
                ...
                <p className="mb-4 lg:[text-align-last:justify]">
                    ...
                    Une <em>« Horizontale »</em> et une <em>« Verticale »</em> de sept vins, animées par un sommelier, le tarif est de 50€ par personne.
                    Possibilité de vous réserver une bonne table et proche du Château d'Hugues.
                </p>

                <p className="lg:[text-align-last:justify]">
                    Pour les bouteilles <strong>« Millésimes 1999 à 1988, fin du XXème siècle »</strong>, cela fait longtemps que nous en avons débouché... Ce sont des pièces de collection !
                </p>
                <p className="mb-4">
                    Aussi, chers amis, clients, futurs clients, particuliers ou professionnels, je vous invite à me contacter par mail, pour les conditions de vente de ces Millésimes et vous présente mes sincères et cordiales salutations.
                </p>
                <p className="mb-6">
