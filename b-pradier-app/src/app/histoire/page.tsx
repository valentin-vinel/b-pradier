...
export default function Histoire() {
    return (
        <div className="min-h-screen flex flex-col max-w-[1200px] m-auto px-3 lg:px-0">
            ...
            <main className="flex flex-col mt-auto text-justify gap-8">
                <article className="flex flex-col gap-10 items-cente lg:flex-row">
                    <figure className="w-[280px] h-[210px] flex flex-col justify-center lg:translate-y-14">
                ...
                <article className="flex flex-col-reverse gap-10 items-center lg:flex-row mb-10 mx-auto">
                    <div>
                    ...
                    <figure className="w-[200px] h-[200px] flex flex-col justify-center mb-6 lg:mb-0 lg:translate-y-10">
                ...
                <article className="flex flex-col-reverse gap-14 items-center lg:flex-row mb-10 mx-auto">
                    <figure className="h-[210px] flex flex-col justify-center w-fit lg:translate-y-10">
                        <Image src={histoire3} alt="Photo de l'entré de la cave" className="min-w-[220px] border-8 border-white"></Image>
                        <figcaption className="text-xs text-center mt-1">- Vendange à la main - <br /> Tableau de B. P.</figcaption>
                    </figure>
                    <div className="max-w-[770px]">
                        <h2 className="text-red text-center my-2 text-2xl">- NOS TROIS CUVÉES DE GARDE -</h2>
                        <p className="[text-align-last:justify]">
