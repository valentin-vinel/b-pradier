        ...
        <div className="min-h-screen flex flex-col max-w-[1200px] m-auto px-3 lg:px-0">
            ...
            <main className="text-justify">
                ...
                <p className="m-auto max-w-[1125px]">
                    Vous découvrirez ci-dessous, les appréciations de la dégustation du 18 octobre 2025, par l'oenologue Olivier Roustang et sa collaboratrice Lydie Gauthier. Celles-ci ont été confirmé le lendemain par deux couples clients, d'âges différents, servi dans des verres classiques. J'ai poursuivi cette «{" "}
                ...
                <section className="py-10 text-center border-b">
                    ...
                    <p className="mb-4">
                        Expressif volubile de fruits à noyau à l'eau de vie, légèrement kirché, puis fève de cacao, noix muscade, <br />
                        notes d'herbes de provence, de genévrier et autres résineux du Massif d'Uchaux.
                    </p>
                ...
                <section className="py-10 text-center border-b">
                    ...
                    <h4 className="text-red text-secondary text-[22px]">- Accord vin / mets -</h4>
                    <p className="mb-4">
                        Tous les plats traditionnels, comme en cette saison une Daube au vin, marinés même dans une Grande Réserve 2005, <br />
                ...
                <section className="py-10 text-center">
                    ...
                    <h4 className="text-red text-secondary text-[22px]">- Au nez -</h4>
                    <p className="mb-4">
                        Très expressif, « <em>qui vient à soi</em> », impression de chocolat sucrant, de ésineux rappelant le Benjoin....
                    </p>

                    <h4 className="text-red text-secondary text-[22px]">- En bouche -</h4>
                    <p className="mb-4">
                        Encore une belle fraîcheur... de jeunesse! Attaque franche avec de suite, un rappel de fruits. Tannins fermes <br />
                        et robustes qui soutiennent un édifice qui a encore du chemin à parcourir...
                    </p>
