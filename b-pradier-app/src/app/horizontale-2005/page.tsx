            ...
            <main className="text-justify">
                ...
                <section className="py-10 text-center border-b">
                    ...
                    <figure className="m-auto text-center mb-8 ">
                        ...
                        <figcaption className="text-base my-2">Première bouteille à gauche, ci-dessus, de la photo non contractuelle.</figcaption>
                ...
                <section className="py-10 text-center border-b">
                    ...
                    <figure className="m-auto text-center mb-8 ">
                        <Image src={bouteilles} alt="Photo des bouteilles de nos 3 cuvées, non contractuelle." className="m-auto w-[200px] shadow-2xl border-bouteille relative"></Image>
                        <figcaption className="text-base my-2">Bouteille au centre, ci-dessus, de la photo non contractuelle.</figcaption>
                        <p className="text-base">13.5% vol. Bouteille de 750 ml. Contient des sulfites. Product of France</p>
                    </figure>
                ...
                <section className="py-10 text-center">
                    ...
                    <figure className="m-auto text-center mb-8 ">
                        <Image src={bouteilles} alt="Photo des bouteilles de nos 3 cuvées, non contractuelle." className="m-auto w-[200px] shadow-2xl border-bouteille relative"></Image>
                        <figcaption className="text-base my-2">Troisième bouteille, ci-dessus, de la photo non contractuelle</figcaption>
                        <p className="text-base">13.5% vol. Bouteille de 750 ml. Contient des sulfites. Product of France</p>
                    </figure>
                    ...
                    <h4 className="text-red text-secondary text-[22px]">- En conclusion -</h4>
                    <p className="mb-4">Un vin qui a de l'identité, de la dimension et de la profondeur... <br />Équilibré, alliant force et douceur, ce que confirme sa persistance.</p>
