            ...
            <main className="mb-6">
                ...
                <div className="grid grid-cols-3 gap-6 m-auto text-center w-fit">
                    <figure className="flex flex-col justify-center items-center relative">
                        ...
                        <p className="text-3xl text-white absolute h-fit m-auto translate-y-6 w-[180px] font-bold text-cookie">GRANDE RÉSERVE</p>
                        ...
                        <article key={i} className="flex flex-col gap-4 mb-6 items-center">
                            <figure className="flex flex-col justify-center items-center relative">
                                ...
                                <figcaption className="lgd-bouchon text-3xl absolute h-fit m-auto translate-x-4 top-1.5 w-[140px] font-bold leading-0 hover:cursor-pointer hover:text-[#6b1e1e]">
                                    <Link href={"/millesimes/X"}><span className="text-base">VOIR</span> <br />{element.annee}</Link>
                                </figcaption>
                            </figure>
